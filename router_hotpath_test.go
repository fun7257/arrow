...
// Zero-middleware routes use serveRequest (router fast path). These tests drive
// app.Handler().ServeHTTP without app.Use so minimal/static benchmarks share
// the same dispatch/recover/After semantics as the middleware pipeline.
